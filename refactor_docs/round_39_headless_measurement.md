...
Generated: 2026-05-19T12:50:28+09:00
...
```powershell
python tools/measure_web_session_startup.py --entrypoint headless --port 7291 --cdp-port 9391 --include-generate
```
...
| Metric | Seconds |
| --- | --- |
| `fastapi_listen` | 1.438 |
| `api_status_200` | 1.485 |
| `remote_web_first_paint` | 2.36 |
| `random_click_to_prompt_update` | 6.062 |
...
| `after_listen` | 118.6 |
| `after_status` | 118.89 |
| `after_first_paint` | 123.48 |
| `after_action_ready` | 124.11 |
| `after_random` | 1345.8 |
| `after_generate_dispatch` | 1345.81 |
| `after_shutdown` | None |
...
| Log | Path |
| --- | --- |
| `stdout` | C:\VNR\NAIA2.0\logs\round30_web_session_7291_20260519_125028.out.log |
| `stderr` | C:\VNR\NAIA2.0\logs\round30_web_session_7291_20260519_125028.err.log |
| `import_audit` | C:\VNR\NAIA2.0\logs\round30_import_audit_7291_20260519_125028.jsonl |
