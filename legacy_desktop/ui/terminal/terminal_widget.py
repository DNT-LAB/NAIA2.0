...
from legacy_desktop.ui.terminal.terminal_bridge import TerminalBridge
from legacy_desktop.ui.terminal.terminal_manager import TerminalManager
from legacy_desktop.ui.terminal.pty_backend import get_default_shell
...
class TerminalWidget(QWidget):
    ...
    def _open_sketch_window(self):
        ...
        if self._sketch_window is not None:
            ...
            return
        from legacy_desktop.ui.terminal.paint_panel import SketchWindow
