...
const interactivePanelReady = import('./js/features/interactivePanel.mjs?v=20260812u-restore')
  .then(async ({createInteractivePanel}) => {
    ...
    const {createInteractiveScenePanel} =
      await import('./js/features/interactiveScenePanel.mjs?v=20260812u-restore');
...
const tagAssistReady = import('./js/features/tagAssist.mjs?v=20260812u-restore')
