...
const interactivePanelReady = import('./js/features/interactivePanel.mjs?v=20260817-aside400b')
  .then(async ({createInteractivePanel}) => {
    ...
    const {createInteractiveAssetsPanel} =
      await import('./js/features/interactiveAssetsPanel.mjs?v=20260817-aside400b');
    ...
    const {createInteractiveScenePanel} =
      await import('./js/features/interactiveScenePanel.mjs?v=20260817-aside400b');
...
const tagAssistReady = import('./js/features/tagAssist.mjs?v=20260817-aside400b')
