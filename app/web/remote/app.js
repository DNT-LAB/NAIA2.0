...
const interactivePanelReady = import('./js/features/interactivePanel.mjs?v=20260812n-ctx')
  .then(async ({createInteractivePanel}) => {
    ...
    const {createInteractiveScenePanel} =
      await import('./js/features/interactiveScenePanel.mjs?v=20260812n-ctx');
...
const tagAssistReady = import('./js/features/tagAssist.mjs?v=20260812n-ctx')
