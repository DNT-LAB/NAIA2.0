...
# 🆕 퀵 서치 탭 Mixin import
from legacy_desktop.ui.remote.quick_search_tab import QuickSearchTabMixin

# 🆕 이벤트 탭 Mixin import
from legacy_desktop.ui.remote.event_tab import (
...
from legacy_desktop.ui.remote.instant_wc_tab import (
    InstantWcTabMixin, WildcardItemWidget,
    WC_THUMB_WIDTH, WC_THUMB_HEIGHT
)

# 🆕 캐릭터 프롬프트 탭 Mixin import
from legacy_desktop.ui.remote.char_prompt_tab import (
