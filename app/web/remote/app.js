...
const artistThumbReady = import('./js/features/artistThumbTab.mjs?v=20260921-detail2')
...
const interactivePanelReady = import('./js/features/interactivePanel.mjs?v=20260913-gap3385')
...
const setupControllerReady = import('./js/features/setupController.mjs?v=20260919-no-api')
  .then(({createSetupController}) => {
    ...
    return import('./js/features/naiAccountPanel.mjs?v=20260920-basis23')
...
const characterPanelReady = import('./js/features/characterPanel.mjs?v=20260913-restorecopy')
...
const characterQuickPanelReady = import('./js/features/characterQuickPanel.mjs?v=20260920-scroll')
...
const searchPanelReady = import('./js/features/searchPanel.mjs?v=20260925-sqhs')
...
const naiPreviewWindowReady = import('./js/features/naiPreviewWindow.mjs?v=20260903-genlabel')
...
const tagAssistReady = import('./js/features/tagAssist.mjs?v=20260925-sqhs')
