...
def register_interactive_advice_routes(app: FastAPI, context: Any) -> None:
    ...
    async def interactive_advice(tag: str = ""):   # noqa: ANN202
        return JSONResponse(_advise_one(tag, pack.get(), _dependency_index()))
    ...
    async def interactive_advice_batch(tags: str = ""):   # noqa: ANN202
        ...
        return JSONResponse({"items": [_advise_one(n, harmony, dep) for n in names]})
