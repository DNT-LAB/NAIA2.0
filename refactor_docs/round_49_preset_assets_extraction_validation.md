...
Generated: 2026-05-19T16:54:21+09:00
...
```powershell
python tools/measure_web_session_startup.py --entrypoint headless --port 7313 --cdp-port 9413 --include-generate
```
...
| --- | --- |
| `fastapi_listen` | 1.11 |
| `api_status_200` | 1.156 |
| `remote_web_first_paint` | 2.031 |
| `random_click_to_prompt_update` | 6.562 |
...
| `after_listen` | 118.96 |
| `after_status` | 119.34 |
| `after_first_paint` | 124.76 |
| `after_action_ready` | 125.28 |
| `after_random` | 1315.08 |
| `after_generate_dispatch` | 1315.1 |
| `after_shutdown` | None |
...
| Log | Path |
| --- | --- |
| `stdout` | C:\VNR\NAIA2.0\logs\round30_web_session_7313_20260519_165421.out.log |
| `stderr` | C:\VNR\NAIA2.0\logs\round30_web_session_7313_20260519_165421.err.log |
| `import_audit` | C:\VNR\NAIA2.0\logs\round30_import_audit_7313_20260519_165421.jsonl |
...
## Round 49F Static Checks

- `python -m compileall -q core\clothes_preset core\expression_preset`
- `python -m py_compile core\clothes_preset_service.py core\expression_preset_service.py ui\clothes_preset\clothes_preset_window.py ui\clothes_preset\widgets.py`
- `python -m pytest tests\test_clothes_preset_service.py tests\test_expression_preset_service.py -q` -> 22 passed
- `python -m pytest tests\test_preset_composer_service.py tests\test_preset_input_bridge.py -q` -> 44 passed
...
`core.clothes_preset_service` and `core.expression_preset_service` no longer depend on server assets under `ui/`. The remaining root `ui/` tracked files are now candidates for the PyQt wrapper archive, except `ui/remote_web` static assets.
