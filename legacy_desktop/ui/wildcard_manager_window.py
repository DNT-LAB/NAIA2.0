...
from legacy_desktop.ui.theme import DARK_STYLES, get_dynamic_styles, DARK_COLORS
...
class WildcardManagerWindow(QMainWindow):
    ...
    def open_simulator(self):
        ...
        """
        try:
            from legacy_desktop.ui.wildcard_simulator_dialog import WildcardSimulatorDialog
