...
class InteractiveWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        # 인원수 / 이미지 목적 블록
        from legacy_desktop.ui.interactive.person_settings_block import PersonSettingsBlock
        self.person_block = PersonSettingsBlock()  # ✅ self 저장
        left_layout.addWidget(self.person_block)

        # 퀵 서치 블록
        from legacy_desktop.ui.interactive.quick_search_block import QuickSearchBlock
        ...
        # 아티스트 태그 블록
        from legacy_desktop.ui.interactive.artist_tag_block import ArtistTagBlock
        ...
        # 퀄리티 태그 블록
        from legacy_desktop.ui.interactive.quality_tag_block import QualityTagBlock
        self.quality_block = QualityTagBlock()  # ✅ self 저장
        #self.quality_block.set_collapsed(False)
        left_layout.addWidget(self.quality_block)

        # 네거티브 프롬프트 블록
        from legacy_desktop.ui.interactive.negative_prompt_block import NegativePromptBlock
        ...
        from legacy_desktop.ui.interactive.image_plane import ImagePlane
        ...
        # [하단 중앙] 컨트롤 바 (고정 배치)
        from legacy_desktop.ui.interactive.floating_control_bar import FloatingControlBar
        ...
        from legacy_desktop.ui.interactive.draggable_panel import FloatingPanelManager
        ...
        from legacy_desktop.ui.interactive.draggable_panel import DraggablePanel
        from legacy_desktop.ui.interactive.main_prompt_block import MainPromptBlock
        ...
        from legacy_desktop.ui.interactive.interactive_autocomplete import InteractiveAutocompleteManager
        ...
        from legacy_desktop.ui.interactive.additional_negative_prompt_block import AdditionalNegativePromptBlock
        ...
        # [플로팅] 구도 설정 블록
        from legacy_desktop.ui.interactive.composition_block import CompositionBlock
        ...
        from legacy_desktop.ui.interactive.character_reference_block import CharacterReferenceBlock
        ...
        # [플로팅] 이미지 태거 블록 (WD14)
        from legacy_desktop.ui.interactive.image_tagger_block import ImageTaggerBlock
        ...
        from legacy_desktop.ui.interactive.tag_viewer_widget import TagViewerWidget
        from legacy_desktop.ui.interactive.draggable_panel import DraggablePanel
        ...
        # [플로팅] 캐릭터 프롬프트 블록 6개
        from legacy_desktop.ui.interactive.character_prompt_block import CharacterPromptBlock
