...
const resultHistoryReady = import('./js/features/resultHistory.mjs?v=20260810a-hashfix')
...
const interactivePanelReady = import('./js/features/interactivePanel.mjs?v=20260814a-adultgate')
  .then(async ({createInteractivePanel}) => {
    ...
    const {createInteractiveAssetsPanel} =
      await import('./js/features/interactiveAssetsPanel.mjs?v=20260814a-adultgate');
    ...
    const {createInteractiveScenePanel} =
      await import('./js/features/interactiveScenePanel.mjs?v=20260814a-adultgate');
...
const tagAssistReady = import('./js/features/tagAssist.mjs?v=20260814a-adultgate')
