...
const interactivePanelReady = import('./js/features/interactivePanel.mjs?v=20260817-textchip2')
  .then(async ({createInteractivePanel}) => {
    ...
    const {createInteractiveAssetsPanel} =
      await import('./js/features/interactiveAssetsPanel.mjs?v=20260817-textchip2');
    ...
    const {createInteractiveScenePanel} =
      await import('./js/features/interactiveScenePanel.mjs?v=20260817-textchip2');
...
const tagAssistReady = import('./js/features/tagAssist.mjs?v=20260817-textchip2')
