...
Generated: 2026-05-19T16:13:34+09:00
...
```powershell
python tools/measure_web_session_startup.py --entrypoint headless --port 7308 --cdp-port 9408 --include-generate
```
...
| `random_click_to_prompt_update` | 6.453 |
...
| `after_listen` | 119.37 |
| `after_status` | 119.79 |
| `after_first_paint` | 124.84 |
| `after_action_ready` | 124.92 |
| `after_random` | 1305.59 |
| `after_generate_dispatch` | 1305.62 |
| `after_shutdown` | None |
...
| Log | Path |
| --- | --- |
| `stdout` | C:\VNR\NAIA2.0\logs\round30_web_session_7308_20260519_161334.out.log |
| `stderr` | C:\VNR\NAIA2.0\logs\round30_web_session_7308_20260519_161334.err.log |
| `import_audit` | C:\VNR\NAIA2.0\logs\round30_import_audit_7308_20260519_161334.jsonl |
