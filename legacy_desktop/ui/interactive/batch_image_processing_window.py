...
from legacy_desktop.ui.interactive.interactive_theme import COMMON_STYLES, get_button_style, FONT_FAMILY
...
class BatchImageProcessingWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        from legacy_desktop.ui.interactive.image_tagger_block import ThresholdButton
