...
const setupControllerReady = import('./js/features/setupController.mjs?v=20260716-sleepwake-reprobe1')
  .then(({createSetupController}) => {
    ...
    return import('./js/features/naiAccountPanel.mjs?v=20260825-maint1')
...
const img2imgPanelReady = import('./js/features/img2imgPanel.mjs?v=20260826-automask1')
...
const inpaintCanvasReady = import('./js/features/inpaintCanvasPanel.mjs?v=20260826-automask1')
