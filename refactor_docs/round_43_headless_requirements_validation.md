...
Generated: 2026-05-19T14:50:01+09:00
...
```powershell
python tools/measure_web_session_startup.py --entrypoint headless --port 7296 --cdp-port 9396 --include-generate
```
...
| `remote_web_first_paint` | 1.797 |
| `random_click_to_prompt_update` | 6.438 |
...
| `after_listen` | 118.55 |
| `after_status` | 118.84 |
| `after_first_paint` | 121.09 |
| `after_action_ready` | 124.95 |
| `after_random` | 1342.14 |
| `after_generate_dispatch` | 1342.15 |
| `after_shutdown` | None |
...
| Log | Path |
| --- | --- |
| `stdout` | C:\VNR\NAIA2.0\logs\round30_web_session_7296_20260519_145001.out.log |
| `stderr` | C:\VNR\NAIA2.0\logs\round30_web_session_7296_20260519_145001.err.log |
| `import_audit` | C:\VNR\NAIA2.0\logs\round30_import_audit_7296_20260519_145001.jsonl |
