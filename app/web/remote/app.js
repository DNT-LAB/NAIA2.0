...
const interactivePanelReady = import('./js/features/interactivePanel.mjs?v=20260812w-bars')
  .then(async ({createInteractivePanel}) => {
    ...
    const {createInteractiveScenePanel} =
      await import('./js/features/interactiveScenePanel.mjs?v=20260812w-bars');
...
const tagAssistReady = import('./js/features/tagAssist.mjs?v=20260812w-bars')
