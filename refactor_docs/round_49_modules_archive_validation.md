...
Generated: 2026-05-19T16:32:48+09:00
...
```powershell
python tools/measure_web_session_startup.py --entrypoint headless --port 7310 --cdp-port 9410 --include-generate
```
...
| `remote_web_first_paint` | 2.11 |
| `random_click_to_prompt_update` | 6.36 |
...
| `after_listen` | 119.29 |
| `after_status` | 119.7 |
| `after_first_paint` | 122.35 |
| `after_action_ready` | 125.18 |
| `after_random` | 1347.45 |
| `after_generate_dispatch` | 1347.47 |
| `after_shutdown` | None |
...
| Log | Path |
| --- | --- |
| `stdout` | C:\VNR\NAIA2.0\logs\round30_web_session_7310_20260519_163248.out.log |
| `stderr` | C:\VNR\NAIA2.0\logs\round30_web_session_7310_20260519_163248.err.log |
| `import_audit` | C:\VNR\NAIA2.0\logs\round30_import_audit_7310_20260519_163248.jsonl |
